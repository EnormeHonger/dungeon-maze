...
public class ChestPopulator extends MazeRoomBlockPopulator {
	...
	private List < ItemStack > generateChestContents(Random random, int extraLoot) {
		...
		if (random.nextInt(100) < 20) items.add(new ItemStack(Material.LEATHER_BOOTS, 1, (short) 0));
		if (random.nextInt(100) < 40) items.add(new ItemStack(Material.CHAINMAIL_HELMET, 1, (short) 0));
		if (random.nextInt(100) < 40) items.add(new ItemStack(Material.CHAINMAIL_CHESTPLATE, 1, (short) 0));
		if (random.nextInt(100) < 40) items.add(new ItemStack(Material.CHAINMAIL_LEGGINGS, 1, (short) 0));
		if (random.nextInt(100) < 40) items.add(new ItemStack(Material.CHAINMAIL_BOOTS, 1, (short) 0));
		if (random.nextInt(100) < 10) items.add(new ItemStack(Material.IRON_HELMET, 1, (short) 0));
		if (random.nextInt(100) < 10) items.add(new ItemStack(Material.IRON_CHESTPLATE, 1, (short) 0));
		if (random.nextInt(100) < 10) items.add(new ItemStack(Material.IRON_LEGGINGS, 1, (short) 0));
		if (random.nextInt(100) < 10) items.add(new ItemStack(Material.IRON_BOOTS, 1, (short) 0));
